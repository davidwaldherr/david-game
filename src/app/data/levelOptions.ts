...
export const cardLevels: CardType[] = [
  ...
  {
    Title: "Inbound Search Leads",
    Logo: "/path/to/inbound_search_leads_logo.png",
    Category: "Business",
    Type: "Finite Game",
    Description: "Attract and convert high-quality inbound search leads.",
    Options: [],
    BackgroundStory: "Generate valuable inbound leads with our proven strategies.",
    Animation: "Subtle, zoom-in motion",
    ColorScheme: "Gradient from navy blue to white",
    PixelBorder: "rgb(255, 255, 255)",
    Link: "https://www.inbound.game",
  },
  {
    Title: "Learning",
